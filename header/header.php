...
<div id="rulesPopup" class="popup">
    <h2>ゲームのルール</h2>
    <h3>ゲームの基本設定</h3>
    <h4>チーム分け：プレイヤーは2つのチーム（赤チームと青チーム）に分かれます。それぞれのチームには1人のオペレーターと数人のアストロノーツがいます。<br>カード配置：25枚のカードが5x5のグリッドに配置されます。それぞれのカードには1つの単語が書かれています。</h4>
    <h2>ゲームの進行</h2>
    <h4>ヒントを出す：各ラウンド、スパイマスターは自分のチームにヒントを1つ出します。ヒントは1つの単語と数字からなります（例：「動物 3」）。このヒントはチームの単語を推測するための手がかりとなります。</h4>
    <h4>推測：フィールドエージェントはスパイマスターのヒントに基づいて、カードを推測します。推測は1つずつ行い、カードをクリックして確認します。<br>・正しい単語（チームの色のカード）を当てた場合、推測を続けるかどうかを決めます。<br>・間違った単語（相手チームの色のカード、または中立カード）を当てた場合、そのターンは終了します。<br><br>ターンの終了：チームの推測が終わるとターンが終了し、次のチームに移ります。</h4>
    <h2>勝利条件</h2>
    <h4>全ての単語を当てる：先に全ての自分のチームの単語を正しく推測したチームが勝利します。<br><br>エイリアンの単語を当てたチームは即座に敗北します。</h4>
