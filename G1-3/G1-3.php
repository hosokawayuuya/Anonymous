...
<div class="stars">
    ...
    <div class="container">
        ...
        <div class="info-box">
            <h1>ルール</h1>
            <h2>ゲームの基本設定</h2>
        <p>チーム分け：プレイヤーは2つのチーム（赤チームと青チーム）に分かれます。それぞれのチームには1人のオペレーターと1人のアストロノーツがいます。
        それぞれの役割のボタンを選択してください
        <br>
        <br>
        カード配置：25枚のカードが5x5のグリッドに配置されます。それぞれのカードには1つの単語が書かれています。
        <br>
        <br>
        パソコンの画面の大きさを選ぶ際、80%から100%の範囲が特におすすめで、ゲームを楽しむのに最適です。
        <br>
        <br>
        ヘッダーにあるURLをコピーしてほかの三人に共有し、ゲームを始めてください。
        4人集まるとスタートボタンが出てきて、ゲームを始めることができます！！！！
        </p>
